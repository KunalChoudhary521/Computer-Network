...
exact_S = 10000 + (100.* (recv_time - 100000));
est_S1 = (100 .* recv_time) - Bmax1;
est_S2 = (101 .* recv_time2) - Bmax2;
est_S3 = (101 .* recv_time3) - Bmax3;

%Graphing all service curves:
figure(2);
plot(recv_time,exact_S,'r',recv_time,est_S1,'g',recv_time2,est_S2,'b',recv_time2,est_S2,'m');
title('Service Curves: L=10,000,000 bytes, N=200,000');
