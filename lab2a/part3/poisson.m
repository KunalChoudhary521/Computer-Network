...
%data of trace file
[seqNo,t_p,size_p] = textread('TGenPos.txt', '%f %f %f');
...
[recv_time, size_tb, buffer_bk_log, tokens] = textread('bucketPos.txt', '%f %f %f %f');
...
[seqNo,t_p,size_p] = textread('TSinkPos.txt', '%f %f %f');
