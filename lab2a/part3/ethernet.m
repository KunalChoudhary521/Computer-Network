...
%data of trace file
[seqNo,t_p,size_p] = textread('TGenEth.txt', '%f %f %f');
...
[recv_time, size_tb, buffer_bk_log, tokens] = textread('bucketEthernet.txt', '%f %f %f %f');
time_bucket = zeros(1,size(seqNo,1));
bucket_arrival = zeros(1,size(seqNo,1));
...
[seqNo,t_p,size_p] = textread('TSinkEth.txt', '%f %f %f');
