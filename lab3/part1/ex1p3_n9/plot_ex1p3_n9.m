clear all; clc;
%plot backlog, waiting time, # packets discarded as function of time for N=9
...
schdfile = 'ps_ex1-3-N9.txt';
sinkfile = 'TSinkOut_ex1-3-N9.txt';
...
title('Discarded Packets for N = 9');
xlabel('Time (microseconds)');
ylabel('# of Packets');
